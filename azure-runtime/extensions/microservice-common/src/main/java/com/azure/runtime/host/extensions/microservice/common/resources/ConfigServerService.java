...
public final class ConfigServerService extends DockerFile<ConfigServerService>
      implements ResourceWithTemplate<ConfigServerService>, ResourceWithEndpoints<ConfigServerService>, ResourceWithReference<ConfigServerService> {
    ...
    public ConfigServerService(String name) {
        super(name);
    ...
    public ConfigServerService withPort(int targetPort) {
    ...
    public ConfigServerService withGitRepositoryPath(String gitRepositoryPath) {
    ...
    public List<TemplateFileOutput> processTemplate() {
        ...
        List<TemplateFileOutput> templateOutput = TemplateEngine.getTemplateEngine()
            .process(ConfigServerService.class, templateFiles, properties);
    ...
    @Override
    public ConfigServerService self() {
        return this;
    }
}
